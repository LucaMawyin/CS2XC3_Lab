...
\begin{itemize}
    ...
    \item For each list, create a BST and RBT by using the lists of integers.
    \item Get the height of each tree and add it to a running sum of heights for each tree
\end{itemize}
%\begin{figure}[H]
%	\centering
