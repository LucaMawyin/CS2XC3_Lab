...
\stepcounter{section}
\section*{Experiment \thesection}
In our experiment comparing Bubble Sort, Insertion Sort, and Selection Sort on sorted lists with varying numbers of swaps made. We ran 301 tests for each sorting algorithm on lists of size 2000 with the number of swaps ranging from 0 - 30179. Each test would increase the number of swaps made by 100.
