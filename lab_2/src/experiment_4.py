...
approx1SumList = [results[edgeLength]["approx1"] / results[edgeLength]["MVC"] for edgeLength in listOfEdgesInGraphs]
approx2SumList = [results[edgeLength]["approx2"] / results[edgeLength]["MVC"] for edgeLength in listOfEdgesInGraphs]
approx3SumList = [results[edgeLength]["approx3"] / results[edgeLength]["MVC"] for edgeLength in listOfEdgesInGraphs]
...
plt.ylabel("Relative Margin (Approx / MVC)")
