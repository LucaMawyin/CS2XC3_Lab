...
class AStarElement():
    def __init__(self, value, g_score, h_score):
        self.value = value
    ...
    @property
    def key(self):
        return self.g_score + self.h_score  # current weight + estimated weight left (which is a lower bound)
...
def a_star(G: DirectedWeightedGraph, s, d, h):
    ...
    while not Q.is_empty():
        ...
        dist[current_node] = current_element.g_score
